""" 
This file contains the full model architecture for the VGG model.
This includes a thin ResNet & VLAD pooling layers.
Code was written by the authors of the VGG model.
"""
...
import sr_resnet_architecture as backbone
